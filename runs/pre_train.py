...
class DGCNNSeg(nn.Module):
    def __init__(self, args, num_classes):
        ...
        # Calculate input dimension for segmenter
    ...
    def forward(self, pc):
        ...
        # Get unified output from encoder
        encoder_output = self.encoder(pc)
        edgeconv_feats = encoder_output['multi_scale_feats']
        point_feat = encoder_output['final_feat']
